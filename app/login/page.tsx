      ...
      <div style={{ background: "#1a1d27", border: "1px solid rgba(255,255,255,0.08)", borderRadius: "20px", padding: "40px", width: "360px" }}>
        ...
        <div style={{ marginBottom: "20px", position: "relative" }}>
          ...
          <input
            ...
            placeholder="••••••••"
            style={{ width: "100%", background: "#232839", border: "1px solid rgba(255,255,255,0.07)", borderRadius: "8px", padding: "10px 12px", paddingRight: "40px", color: "#f0ece4", fontSize: "14px", outline: "none" }}
          />
          <span
            onClick={() => setShowPassword(!showPassword)}
            style={{ position: "absolute", right: "12px", top: "34px", cursor: "pointer", color: "#5a5f78", fontSize: "18px" }}
          >
            {showPassword ? "🙈" : "👁️"}
          </span>
        </div>
